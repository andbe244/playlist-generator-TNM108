...
# Define a function to classify songs into moods (for initial labeling)
...
# Apply the rule-based classification to create initial mood labels
...
new_songs = pd.DataFrame({
    ...
    'lyrics': ["I feel so happy and alive", "I am down and broken", "Let the rhythm take over"]
})
...
user_mood = "Sad"  # Replace with user input for mood
